...
if __name__ == '__main__':
    ...
    with open('r2n_training_data.pkl', mode='rb') as f:
        res = pickle.load(f)
        X, train_files, cycles, stations, temperatures, missions = res[0], res[1], res[2], res[3], res[4], res[5]
    # display some number
    for ct in cyctypes:
    ...
    for ctype in cyctypes:
        ...
        joint_model = kr.models.Model(input_cyc,
                                      ...
                                      name=f'r2n-{ctype}-joint-model-{training_mode}')
        joint_model.compile(
        ...
        tf.keras.utils.plot_model(
            ...
            to_file=f'./plots/r2n/r2n-{ctype}-model-40ft-{training_mode}.png',
        )
        ...
        with open(f'./logs/r2n/train_history_{ctype}_{training_mode}.pkl', mode='wb') as f:
            if training_mode == 'offline':
        ...
        # save the figure
        plt.savefig(f'./plots/r2n/r2n-{ctype}-results-40ft-{training_mode}.png')
        plt.close()
        ...
        """
        print('\nSaving the model...')
        model_path = f'./models/r2n/joint-03-180123/{ctype}/{training_mode}'
        ...
        np.save(f'./features/r2n/r2n-{ctype}-features-{training_mode}.npy', features)
        ...
        if training_mode != 'online':
            ...
            np.save(f'./features/r2n/r2n-{ctype}-trainfeatures-{training_mode}.npy', train_features)
        ...
        metrics_fname = f'./logs/r2n/metrics_40ft_{training_mode}.csv'
