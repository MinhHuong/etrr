...
class MongoDBConnector:
    ...
    HOST = 'localhost'
    PORT = 27017
    DBNAME = {'nat': 'chmoc_nat', 'r2n': 'chmoc_r2n'}
    ...
    def clean(self, expe_name=None):
        ...
        # TODO remember to NOT to delete experiment logs
        # self.db[self.EXPERIMENTS].delete_many({})   # logs of metadata of all experiments
